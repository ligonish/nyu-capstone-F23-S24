---
title: "Team 4 Final Draft Code Walkthrough"
output: 
  html_document:
    toc: yes
    toc_float:
...
tibble(v_codes, v_adm, v_desc) %>%
  kbl(caption = 'Table 6. NYC HPD Housing Maintenance Violation Categories Selected for Study',
...
Table 3. Key Covariate Summaries, by Cohort (to highlight heterogeneity)
...
violations %>% 
  ...
  knitr::kable(digits = 2,
               caption = 'Table 3. Selected Potential Covariates by RTC Treatment Cohort: NYC Renter-Occupied Units, January 2013 - May 2019',
...
knitr::kables(
  ...
  caption = 'Table 5. Aggregated Group-Specific Treatment Effects'
) %>% 
  kable_styling(full_width = F, 
                  html_font = "Roboto Condensed")
```
